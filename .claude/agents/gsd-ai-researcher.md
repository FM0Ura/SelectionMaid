...
<required_reading>
Read `/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
