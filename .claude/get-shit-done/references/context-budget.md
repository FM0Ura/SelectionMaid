...
The keys live in `.claude/settings.json` (project) or `/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/settings.json` (global) — **not** in `.planning/config.json`:
