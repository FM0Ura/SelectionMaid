...
- Usage: Reference from command with `@/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
