...
```bash
INIT=$(node "/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
