...
- **Global scope**: `/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/notes/`)
...
2. Glob `/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/notes/` — works in any directory
