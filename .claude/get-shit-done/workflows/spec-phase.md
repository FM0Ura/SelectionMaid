...
```bash
INIT=$(node "/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/get-shit-done/templates/spec.md.
