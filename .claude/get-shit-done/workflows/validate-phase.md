...
```
Agent(
  prompt="Read /home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/fmoura-laptop/Documentos/Projetos/SelectionMaid/.claude/get-shit-done/templates/VALIDATION.md`
